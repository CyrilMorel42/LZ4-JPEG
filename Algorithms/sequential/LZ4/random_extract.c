...
int main() {
    ...
    int extract_length = 20000; // Adjust length of extract

    extract_random_passage(input_filename, output_filename, extract_length);
    printf("Random passage extracted to %s\n", output_filename);
    return 0;
}
